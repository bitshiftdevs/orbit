...
const { projectId, todos } = defineProps<{
	projectId: string;
	...
	<div class="p-6">
		...
		<form @submit.prevent="addTodo" class="mb-6">
			<div class="space-y-2">
				...
				<Textarea id="todo-description" v-model="newTodoDescription" placeholder="Describe the task..."
					:disabled="loading" class="min-h-[100px]" />
			...
			<div class="space-y-2 mt-4">
				...
				<select id="todo-status" v-model="newTodoStatus"
		...
		<div v-if="todos.length === 0" class="text-gray-400">
			No tasks added yet.
		</div>
